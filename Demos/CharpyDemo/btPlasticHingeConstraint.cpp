...
btPlasticHingeConstraint::btPlasticHingeConstraint(btRigidBody& rbA,btRigidBody& rbB, const btVector3& pivotInA,const btVector3& pivotInB,
...
btPlasticHingeConstraint::btPlasticHingeConstraint(btRigidBody& rbA,const btVector3& pivotInA,const btVector3& axisInA, bool useReferenceFrameA)
...
btPlasticHingeConstraint::btPlasticHingeConstraint(btRigidBody& rbA,btRigidBody& rbB, 
...
btPlasticHingeConstraint::btPlasticHingeConstraint(btRigidBody& rbA, const btTransform& rbAFrame, bool useReferenceFrameA)
...
void	btPlasticHingeConstraint::buildJacobian()
{
...
btScalar btPlasticHingeAccumulatedAngleConstraint::getAccumulatedHingeAngle()
{
	btScalar hingeAngle = getHingeAngle();
	m_accumulatedAngle = btShortestAngleUpdate(m_accumulatedAngle,hingeAngle);
	return m_accumulatedAngle;
}
void	btPlasticHingeAccumulatedAngleConstraint::setAccumulatedHingeAngle(btScalar accAngle)
{
	m_accumulatedAngle  = accAngle;
}

void btPlasticHingeAccumulatedAngleConstraint::getInfo1(btConstraintInfo1* info)
{
	...
	btPlasticHingeConstraint::getInfo1(info);
	
}


void btPlasticHingeConstraint::getInfo1(btConstraintInfo1* info)
{
...
void btPlasticHingeConstraint::getInfo1NonVirtual(btConstraintInfo1* info)
{
	if (m_useSolveConstraintObsolete)
	{
		info->m_numConstraintRows = 0;
...
void	btPlasticHingeConstraint::getInfo2NonVirtual (btConstraintInfo2* info,const btTransform& transA,const btTransform& transB,const btVector3& angVelA,const btVector3& angVelB)
{
...
void btPlasticHingeConstraint::getInfo2Internal(btConstraintInfo2* info, const btTransform& transA,const btTransform& transB,const btVector3& angVelA,const btVector3& angVelB)
{
...
void btPlasticHingeConstraint::setFrames(const btTransform & frameA, const btTransform & frameB)
{
	m_rbAFrame = frameA;
	m_rbBFrame = frameB;
	buildJacobian();
...
void	btPlasticHingeConstraint::updateRHS(btScalar	timeStep)
{
	(void)timeStep;
...
btScalar btPlasticHingeConstraint::getHingeAngle()
{
	return getHingeAngle(m_rbA.getCenterOfMassTransform(),m_rbB.getCenterOfMassTransform());
}

btScalar btPlasticHingeConstraint::getHingeAngle(const btTransform& transA,const btTransform& transB)
{
...
void btPlasticHingeConstraint::setMotorTarget(const btQuaternion& qAinB, btScalar dt)
{
...
void btPlasticHingeConstraint::setMotorTarget(btScalar targetAngle, btScalar dt)
{
#ifdef	_BT_USE_CENTER_LIMIT_
...
void btPlasticHingeConstraint::getInfo2InternalUsingFrameOffset(btConstraintInfo2* info, const btTransform& transA,const btTransform& transB,const btVector3& angVelA,const btVector3& angVelB)
{
	btAssert(!m_useSolveConstraintObsolete);
...
void btPlasticHingeConstraint::setParam(int num, btScalar value, int axis)
{
	if((axis == -1) || (axis == 5))
	{
		switch(num)
...
btScalar btPlasticHingeConstraint::getParam(int num, int axis) const 
{
	btScalar retVal = 0;
	if((axis == -1) || (axis == 5))
	{
