...
void bt6DofElasticPlastic2Constraint::setStiffness(int index, btScalar stiffness)
{
	btAssert((index >= 0) && (index < 6));
	if (index<3)
...
void bt6DofElasticPlastic2Constraint::setDamping(int index, btScalar damping)
{
	btAssert((index >= 0) && (index < 6));
	if (index<3)
