...
Single simulation step is performed using following substeps. 
...
\begin {table}[htb!]
\caption {Simulation values for unconstrained case without continuous collision detection. 
...
\caption{Graph for selected values for unconstrained case simulation without continuous collision detection.}
\label{fig:uc}
\end{figure}
