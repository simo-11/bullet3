...
equilibriumPoint & should elastic behaviour be tuned to avoid instability
 \\  \hline
currentLimit & describes state of constraint - 0: not limited,
 3: loLimit=hiLimit, 4: current value is between loLimit and HiLimit
 \\ \hline
...
spring if needed.
If this feature is active for elastic-plastic constraint 2 constraint it behaves as shown in table
...
{\bf Impulse} & 
{\bf Plastic strain} \\  \hline
0.017... &  0 & -0.17  & 2.34 & 13000 & 0       & 1000 & 0 \\  \hline
\end {tabular}
\end{center}
