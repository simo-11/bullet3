...
\node[anchor=west] at (4.5,3) {$\vec{r}_{anc}^{\,i} $ = anchor point for body i};
\end{tikzpicture}
...
For rectangular section lagrange multiplier limits
...
\begin{tabular}{l}
maximum force in x direction = $0.5\, b\, h f_y$ \\
maximum force in y direction = $b\, h\, f_y$  \\
maximum force in z direction = $0.5\, b\, h\, f_y$  \\
\\
