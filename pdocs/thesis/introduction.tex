...
\begin{tikzpicture}
  ...
  \end{scope}
  \node at ( 90:4)   [align=left] {structural analysis\\
material plasticity};
  \node at ( 210:4)   [align=left] {physics engine\\
rigid bodies\\
constraints};
  \node at ( 330:4)   [align=left] {programming\\
extending of bulletphysics\\
verification
};
  \node {\begin{varwidth}{2cm}plasticity in constraints\end{varwidth}};
\end{tikzpicture}
