...
Difference between elastic and plastic modulus is shown in \ref{fig:wp}. 
...
so plastic modulus is higher than elastic modulus.

Elastic part is often ignored in this work as displacements due to to elastic deformation are so small and 
related frequencies are so high.
